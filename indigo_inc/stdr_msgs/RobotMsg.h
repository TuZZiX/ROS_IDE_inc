...
struct MD5Sum< ::stdr_msgs::RobotMsg_<ContainerAllocator> >
{
  ...
  {
    return "d0aeceebb060b8c4981c7896cd1d7f2c";
  }

  static const char* value(const ::stdr_msgs::RobotMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd0aeceebb060b8c4ULL;
  static const uint64_t static_value2 = 0x981c7896cd1d7f2cULL;
};
