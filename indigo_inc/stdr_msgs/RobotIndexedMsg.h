...
struct MD5Sum< ::stdr_msgs::RobotIndexedMsg_<ContainerAllocator> >
{
  ...
  {
    return "d9e8ee55483fd384e2eafb4fed52e4bd";
  }

  static const char* value(const ::stdr_msgs::RobotIndexedMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd9e8ee55483fd384ULL;
  static const uint64_t static_value2 = 0xe2eafb4fed52e4bdULL;
};
