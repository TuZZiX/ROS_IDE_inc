...
struct MD5Sum< ::stdr_msgs::SpawnRobotResult_<ContainerAllocator> >
{
  ...
  {
    return "a976f446acede426cfeda793a3027f4e";
  }

  static const char* value(const ::stdr_msgs::SpawnRobotResult_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa976f446acede426ULL;
  static const uint64_t static_value2 = 0xcfeda793a3027f4eULL;
};
