...
//#line 262 "/opt/ros/indigo/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(MLSConfig::AbstractParamDescriptionConstPtr(new MLSConfig::ParamDescription<int>("spatial_locator", "int", 0, "Set the spatial locator", "{'enum_description': 'Set the spatial locator', 'enum': [{'srcline': 9, 'description': 'ANN', 'srcfile': '/tmp/buildd/ros-indigo-pcl-ros-1.2.7-0trusty-20151111-0815/cfg/MLS.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'ANN'}, {'srcline': 9, 'description': 'FLANN', 'srcfile': '/tmp/buildd/ros-indigo-pcl-ros-1.2.7-0trusty-20151111-0815/cfg/MLS.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'FLANN'}, {'srcline': 9, 'description': 'Dense/organized data locator', 'srcfile': '/tmp/buildd/ros-indigo-pcl-ros-1.2.7-0trusty-20151111-0815/cfg/MLS.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'organized'}]}", &MLSConfig::spatial_locator)));
//#line 262 "/opt/ros/indigo/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/tmp/buildd/ros-indigo-pcl-ros-1.2.7-0trusty-20151111-0815/cfg/MLS.cfg"
      const int MLS_ANN = 0;
//#line 9 "/tmp/buildd/ros-indigo-pcl-ros-1.2.7-0trusty-20151111-0815/cfg/MLS.cfg"
