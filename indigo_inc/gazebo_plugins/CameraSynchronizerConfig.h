...
//#line 262 "/opt/ros/indigo/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(CameraSynchronizerConfig::AbstractParamDescriptionConstPtr(new CameraSynchronizerConfig::ParamDescription<int>("projector_mode", "int", 31, "Indicates whether the projector should be off, on when in use or on all the time.", "{'enum_description': 'The projectors operating mode.', 'enum': [{'srcline': 56, 'description': 'The projector is always off.', 'srcfile': '/tmp/buildd/ros-indigo-gazebo-plugins-2.4.9-0trusty-20151111-0933/cfg/CameraSynchronizer.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'ProjectorOff'}, {'srcline': 57, 'description': 'The projector is on if one of the cameras is using it.', 'srcfile': '/tmp/buildd/ros-indigo-gazebo-plugins-2.4.9-0trusty-20151111-0933/cfg/CameraSynchronizer.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'ProjectorAuto'}, {'srcline': 58, 'description': 'The projector is always on.', 'srcfile': '/tmp/buildd/ros-indigo-gazebo-plugins-2.4.9-0trusty-20151111-0933/cfg/CameraSynchronizer.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'ProjectorOn'}]}", &CameraSynchronizerConfig::projector_mode)));
//#line 262 "/opt/ros/indigo/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 262 "/opt/ros/indigo/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(CameraSynchronizerConfig::AbstractParamDescriptionConstPtr(new CameraSynchronizerConfig::ParamDescription<int>("wide_stereo_trig_mode", "int", 3, "Indicates the triggering mode of the wide stereo camera.", "{'enum_description': 'The triggering mode for the wide camera.', 'enum': [{'srcline': 62, 'description': 'The cameras frequency can be set independently of the projector frequency. There is no deterministic phase relation between projector firing and camera triggering.', 'srcfile': '/tmp/buildd/ros-indigo-gazebo-plugins-2.4.9-0trusty-20151111-0933/cfg/CameraSynchronizer.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'IgnoreProjector'}, {'srcline': 63, 'description': 'The camera always exposes while the projector is on.', 'srcfile': '/tmp/buildd/ros-indigo-gazebo-plugins-2.4.9-0trusty-20151111-0933/cfg/CameraSynchronizer.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'WithProjector'}, {'srcline': 64, 'description': 'The camera always exposes while the projector is off.', 'srcfile': '/tmp/buildd/ros-indigo-gazebo-plugins-2.4.9-0trusty-20151111-0933/cfg/CameraSynchronizer.cfg', 'cconsttype': 'const int', 'value': 4, 'ctype': 'int', 'type': 'int', 'name': 'WithoutProjector'}]}", &CameraSynchronizerConfig::wide_stereo_trig_mode)));
//#line 262 "/opt/ros/indigo/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 56 "/tmp/buildd/ros-indigo-gazebo-plugins-2.4.9-0trusty-20151111-0933/cfg/CameraSynchronizer.cfg"
      const int CameraSynchronizer_ProjectorOff = 1;
//#line 57 "/tmp/buildd/ros-indigo-gazebo-plugins-2.4.9-0trusty-20151111-0933/cfg/CameraSynchronizer.cfg"
      const int CameraSynchronizer_ProjectorAuto = 2;
//#line 58 "/tmp/buildd/ros-indigo-gazebo-plugins-2.4.9-0trusty-20151111-0933/cfg/CameraSynchronizer.cfg"
      const int CameraSynchronizer_ProjectorOn = 3;
//#line 61 "/tmp/buildd/ros-indigo-gazebo-plugins-2.4.9-0trusty-20151111-0933/cfg/CameraSynchronizer.cfg"
      const int CameraSynchronizer_InternalTrigger = 1;
//#line 62 "/tmp/buildd/ros-indigo-gazebo-plugins-2.4.9-0trusty-20151111-0933/cfg/CameraSynchronizer.cfg"
      const int CameraSynchronizer_IgnoreProjector = 2;
//#line 63 "/tmp/buildd/ros-indigo-gazebo-plugins-2.4.9-0trusty-20151111-0933/cfg/CameraSynchronizer.cfg"
      const int CameraSynchronizer_WithProjector = 3;
//#line 64 "/tmp/buildd/ros-indigo-gazebo-plugins-2.4.9-0trusty-20151111-0933/cfg/CameraSynchronizer.cfg"
      const int CameraSynchronizer_WithoutProjector = 4;
//#line 65 "/tmp/buildd/ros-indigo-gazebo-plugins-2.4.9-0trusty-20151111-0933/cfg/CameraSynchronizer.cfg"
