...
struct MD5Sum< ::sound_play::SoundRequestGoal_<ContainerAllocator> >
{
  ...
  {
    return "43529ed05bef9015b67d8030a34f6f04";
  }

  static const char* value(const ::sound_play::SoundRequestGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x43529ed05bef9015ULL;
  static const uint64_t static_value2 = 0xb67d8030a34f6f04ULL;
};
