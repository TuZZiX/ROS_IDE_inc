...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3I.pack(_x.recognized_objects.header.seq, _x.recognized_objects.header.stamp.secs, _x.recognized_objects.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.recognized_objects.header.seq, _x.recognized_objects.header.stamp.secs, _x.recognized_objects.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
