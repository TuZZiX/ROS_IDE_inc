...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3I.pack(_x.ground_truth_point_cloud.header.seq, _x.ground_truth_point_cloud.header.stamp.secs, _x.ground_truth_point_cloud.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2I.pack(_x.ground_truth_point_cloud.height, _x.ground_truth_point_cloud.width))
      ...
      _x = self
      buff.write(_struct_B2I.pack(_x.ground_truth_point_cloud.is_bigendian, _x.ground_truth_point_cloud.point_step, _x.ground_truth_point_cloud.row_step))
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_B.pack(self.ground_truth_point_cloud.is_dense))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.ground_truth_point_cloud.header.seq, _x.ground_truth_point_cloud.header.stamp.secs, _x.ground_truth_point_cloud.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.ground_truth_point_cloud.height, _x.ground_truth_point_cloud.width,) = _struct_2I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      (_x.ground_truth_point_cloud.is_bigendian, _x.ground_truth_point_cloud.point_step, _x.ground_truth_point_cloud.row_step,) = _struct_B2I.unpack(str[start:end])
      ...
      (self.ground_truth_point_cloud.is_dense,) = _struct_B.unpack(str[start:end])
