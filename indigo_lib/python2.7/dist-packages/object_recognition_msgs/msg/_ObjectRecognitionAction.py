...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_B.pack(self.action_goal.goal.use_roi))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3I.pack(_x.action_result.result.recognized_objects.header.seq, _x.action_result.result.recognized_objects.header.stamp.secs, _x.action_result.result.recognized_objects.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_goal.goal.use_roi,) = _struct_B.unpack(str[start:end])
      ...
      (_x.action_result.result.recognized_objects.header.seq, _x.action_result.result.recognized_objects.header.stamp.secs, _x.action_result.result.recognized_objects.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
