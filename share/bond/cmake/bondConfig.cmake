...
if("FALSE" STREQUAL "TRUE")
  set(bond_SOURCE_PREFIX /tmp/buildd/ros-indigo-bond-1.7.16-0trusty-20150522-1214)
  set(bond_DEVEL_PREFIX /tmp/buildd/ros-indigo-bond-1.7.16-0trusty-20150522-1214/obj-x86_64-linux-gnu/devel)
  set(bond_INSTALL_PREFIX "")
  set(bond_PREFIX ${bond_DEVEL_PREFIX})
else()
  set(bond_SOURCE_PREFIX "")
  set(bond_DEVEL_PREFIX "")
  set(bond_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bond' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Esteve Fernandez <esteve@osrfoundation.org>' to fix it.")
    endif()
