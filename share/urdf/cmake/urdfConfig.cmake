...
if("FALSE" STREQUAL "TRUE")
  set(urdf_SOURCE_PREFIX /tmp/buildd/ros-indigo-urdf-1.11.8-0trusty-20150911-1743)
  set(urdf_DEVEL_PREFIX /tmp/buildd/ros-indigo-urdf-1.11.8-0trusty-20150911-1743/obj-x86_64-linux-gnu/devel)
  set(urdf_INSTALL_PREFIX "")
  set(urdf_PREFIX ${urdf_DEVEL_PREFIX})
else()
  set(urdf_SOURCE_PREFIX "")
  set(urdf_DEVEL_PREFIX "")
  set(urdf_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@gmail.com>' to fix it.")
    endif()
