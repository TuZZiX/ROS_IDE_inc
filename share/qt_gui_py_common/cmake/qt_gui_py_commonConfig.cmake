...
if("FALSE" STREQUAL "TRUE")
  set(qt_gui_py_common_SOURCE_PREFIX /tmp/buildd/ros-indigo-qt-gui-py-common-0.2.28-0trusty-20150609-2154)
  set(qt_gui_py_common_DEVEL_PREFIX /tmp/buildd/ros-indigo-qt-gui-py-common-0.2.28-0trusty-20150609-2154/obj-x86_64-linux-gnu/devel)
  ...
  set(qt_gui_py_common_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'qt_gui_py_common' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Dorian Scholz <scholz@sim.tu-darmstadt.de>' to fix it.")
    endif()
