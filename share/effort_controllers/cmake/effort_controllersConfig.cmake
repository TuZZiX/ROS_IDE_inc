...
if("FALSE" STREQUAL "TRUE")
  set(effort_controllers_SOURCE_PREFIX /tmp/buildd/ros-indigo-effort-controllers-0.9.2-0trusty-20150911-2159)
  set(effort_controllers_DEVEL_PREFIX /tmp/buildd/ros-indigo-effort-controllers-0.9.2-0trusty-20150911-2159/obj-x86_64-linux-gnu/devel)
  ...
  set(effort_controllers_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'effort_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
    endif()
