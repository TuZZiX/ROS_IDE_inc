...
if("FALSE" STREQUAL "TRUE")
  set(shape_msgs_SOURCE_PREFIX /tmp/buildd/ros-indigo-shape-msgs-1.11.8-0trusty-20150522-1245)
  set(shape_msgs_DEVEL_PREFIX /tmp/buildd/ros-indigo-shape-msgs-1.11.8-0trusty-20150522-1245/obj-x86_64-linux-gnu/devel)
  ...
  set(shape_msgs_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'shape_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@willowgarage.com>' to fix it.")
    endif()
