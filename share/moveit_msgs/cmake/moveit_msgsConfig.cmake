...
if("FALSE" STREQUAL "TRUE")
  set(moveit_msgs_SOURCE_PREFIX /tmp/buildd/ros-indigo-moveit-msgs-0.6.1-0trusty-20150522-1300)
  set(moveit_msgs_DEVEL_PREFIX /tmp/buildd/ros-indigo-moveit-msgs-0.6.1-0trusty-20150522-1300/obj-x86_64-linux-gnu/devel)
  ...
  set(moveit_msgs_INSTALL_PREFIX /opt/ros/indigo)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'moveit_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Ioan Sucan <isucan@google.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'moveit_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@google.com>' to fix it.")
    endif()
