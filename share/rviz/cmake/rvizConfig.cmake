...
if("FALSE" STREQUAL "TRUE")
  set(rviz_SOURCE_PREFIX /tmp/buildd/ros-indigo-rviz-1.11.8-0trusty-20150911-2122)
  set(rviz_DEVEL_PREFIX /tmp/buildd/ros-indigo-rviz-1.11.8-0trusty-20150911-2122/obj-x86_64-linux-gnu/devel)
  set(rviz_INSTALL_PREFIX "")
  set(rviz_PREFIX ${rviz_DEVEL_PREFIX})
else()
  set(rviz_SOURCE_PREFIX "")
  set(rviz_DEVEL_PREFIX "")
  set(rviz_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include;/usr/include/eigen3;/usr/include/OGRE;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'David Gossow <dgossow@gmail.com>, William Woodall <william@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(rviz_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rviz;default_plugin;/usr/lib/x86_64-linux-gnu/libOgreMain.so;/usr/lib/x86_64-linux-gnu/libpthread.so;/usr/lib/x86_64-linux-gnu/libGLU.so;/usr/lib/x86_64-linux-gnu/libGL.so;/usr/lib/x86_64-linux-gnu/libSM.so;/usr/lib/x86_64-linux-gnu/libICE.so;/usr/lib/x86_64-linux-gnu/libX11.so;/usr/lib/x86_64-linux-gnu/libXext.so")
...
set(depends "geometry_msgs;image_geometry;image_transport;interactive_markers;laser_geometry;map_msgs;message_filters;nav_msgs;pluginlib;resource_retriever;roscpp;roslib;sensor_msgs;std_msgs;tf;urdf;visualization_msgs")
