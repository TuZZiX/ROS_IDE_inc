...
if("FALSE" STREQUAL "TRUE")
  set(eigen_stl_containers_SOURCE_PREFIX /tmp/buildd/ros-indigo-eigen-stl-containers-0.1.4-0trusty-20150424-0404)
  set(eigen_stl_containers_DEVEL_PREFIX /tmp/buildd/ros-indigo-eigen-stl-containers-0.1.4-0trusty-20150424-0404/obj-x86_64-linux-gnu/devel)
  ...
  set(eigen_stl_containers_INSTALL_PREFIX /opt/ros/indigo)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'eigen_stl_containers' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Ioan Sucan <isucan@willowgarage.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'eigen_stl_containers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@willowgarage.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${eigen_stl_containers_dep}_FOUND)
      find_package(${eigen_stl_containers_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${eigen_stl_containers_dep} REQUIRED ${depend_list})
  endif()
  ...
  list(APPEND eigen_stl_containers_EXPORTED_TARGETS ${${eigen_stl_containers_dep}_EXPORTED_TARGETS})
endforeach()
