...
if("FALSE" STREQUAL "TRUE")
  set(diagnostic_updater_SOURCE_PREFIX /tmp/buildd/ros-indigo-diagnostic-updater-1.8.8-0trusty-20150808-0138)
  set(diagnostic_updater_DEVEL_PREFIX /tmp/buildd/ros-indigo-diagnostic-updater-1.8.8-0trusty-20150808-0138/obj-x86_64-linux-gnu/devel)
  ...
  set(diagnostic_updater_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'diagnostic_updater' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Austin Hendrix <namniart@gmail.com>, Brice Rebsamen <brice.rebsamen@gmail.com>' to fix it.")
    endif()
