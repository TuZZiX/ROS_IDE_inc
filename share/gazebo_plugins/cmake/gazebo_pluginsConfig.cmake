...
if("FALSE" STREQUAL "TRUE")
  set(gazebo_plugins_SOURCE_PREFIX /tmp/buildd/ros-indigo-gazebo-plugins-2.4.9-0trusty-20150911-2130)
  set(gazebo_plugins_DEVEL_PREFIX /tmp/buildd/ros-indigo-gazebo-plugins-2.4.9-0trusty-20150911-2130/obj-x86_64-linux-gnu/devel)
  ...
  set(gazebo_plugins_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'John Hsu <hsu@osrfoundation.org>' to fix it.")
    endif()
