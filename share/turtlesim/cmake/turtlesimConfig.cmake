...
if("FALSE" STREQUAL "TRUE")
  set(turtlesim_SOURCE_PREFIX /tmp/buildd/ros-indigo-turtlesim-0.5.3-0trusty-20150522-1222)
  set(turtlesim_DEVEL_PREFIX /tmp/buildd/ros-indigo-turtlesim-0.5.3-0trusty-20150522-1222/obj-x86_64-linux-gnu/devel)
  ...
  set(turtlesim_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlesim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
set(turtlesim_EXPORTED_TARGETS "turtlesim_generate_messages_cpp;turtlesim_generate_messages_lisp;turtlesim_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${turtlesim_dep}_FOUND)
      find_package(${turtlesim_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${turtlesim_dep} REQUIRED ${depend_list})
  endif()
