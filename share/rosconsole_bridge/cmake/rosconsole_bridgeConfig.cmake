...
if("FALSE" STREQUAL "TRUE")
  set(rosconsole_bridge_SOURCE_PREFIX /tmp/buildd/ros-indigo-rosconsole-bridge-0.4.2-0trusty-20150522-1820)
  set(rosconsole_bridge_DEVEL_PREFIX /tmp/buildd/ros-indigo-rosconsole-bridge-0.4.2-0trusty-20150522-1820/obj-x86_64-linux-gnu/devel)
  ...
  set(rosconsole_bridge_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosconsole_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>, Ioan Sucan <isucan@gmail.com>' to fix it.")
    endif()
