...
if("FALSE" STREQUAL "TRUE")
  set(actionlib_SOURCE_PREFIX /tmp/buildd/ros-indigo-actionlib-1.11.3-0trusty-20150523-0159)
  set(actionlib_DEVEL_PREFIX /tmp/buildd/ros-indigo-actionlib-1.11.3-0trusty-20150523-0159/obj-x86_64-linux-gnu/devel)
  ...
  set(actionlib_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'actionlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Esteve Fernandez <esteve@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(actionlib_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "actionlib;/usr/lib/x86_64-linux-gnu/libboost_thread.so;/usr/lib/x86_64-linux-gnu/libpthread.so")
