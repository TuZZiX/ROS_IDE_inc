...
if("FALSE" STREQUAL "TRUE")
  set(gazebo_ros_SOURCE_PREFIX /tmp/buildd/ros-indigo-gazebo-ros-2.4.9-0trusty-20150816-0238)
  set(gazebo_ros_DEVEL_PREFIX /tmp/buildd/ros-indigo-gazebo-ros-2.4.9-0trusty-20150816-0238/obj-x86_64-linux-gnu/devel)
  ...
  set(gazebo_ros_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'John Hsu <hsu@osrfoundation.org>, Dave Coleman <davetcoleman@gmail.com>' to fix it.")
    endif()
