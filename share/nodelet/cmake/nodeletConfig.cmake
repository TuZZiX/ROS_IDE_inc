...
if("FALSE" STREQUAL "TRUE")
  set(nodelet_SOURCE_PREFIX /tmp/buildd/ros-indigo-nodelet-1.9.3-0trusty-20150806-1806)
  set(nodelet_DEVEL_PREFIX /tmp/buildd/ros-indigo-nodelet-1.9.3-0trusty-20150806-1806/obj-x86_64-linux-gnu/devel)
  set(nodelet_INSTALL_PREFIX "")
  set(nodelet_PREFIX ${nodelet_DEVEL_PREFIX})
else()
  set(nodelet_SOURCE_PREFIX "")
  set(nodelet_DEVEL_PREFIX "")
  set(nodelet_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nodelet' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Esteve Fernandez <esteve@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(nodelet_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "nodeletlib;/usr/lib/x86_64-linux-gnu/libuuid.so")
