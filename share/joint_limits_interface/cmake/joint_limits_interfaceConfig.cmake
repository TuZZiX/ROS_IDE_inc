...
if("FALSE" STREQUAL "TRUE")
  set(joint_limits_interface_SOURCE_PREFIX /tmp/buildd/ros-indigo-joint-limits-interface-0.9.3-0trusty-20150522-2056)
  set(joint_limits_interface_DEVEL_PREFIX /tmp/buildd/ros-indigo-joint-limits-interface-0.9.3-0trusty-20150522-2056/obj-x86_64-linux-gnu/devel)
  ...
  set(joint_limits_interface_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include;/opt/ros/indigo/include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'joint_limits_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
    endif()
