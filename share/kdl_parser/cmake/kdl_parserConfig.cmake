...
if("FALSE" STREQUAL "TRUE")
  set(kdl_parser_SOURCE_PREFIX /tmp/buildd/ros-indigo-kdl-parser-1.11.8-0trusty-20150911-1754)
  set(kdl_parser_DEVEL_PREFIX /tmp/buildd/ros-indigo-kdl-parser-1.11.8-0trusty-20150911-1754/obj-x86_64-linux-gnu/devel)
...
if(NOT "include;/usr/include/eigen3;/opt/ros/indigo/include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kdl_parser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@gmail.com>' to fix it.")
    endif()
