...
if("FALSE" STREQUAL "TRUE")
  set(eigen_conversions_SOURCE_PREFIX /tmp/buildd/ros-indigo-eigen-conversions-1.11.7-0trusty-20150522-1831)
  set(eigen_conversions_DEVEL_PREFIX /tmp/buildd/ros-indigo-eigen-conversions-1.11.7-0trusty-20150522-1831/obj-x86_64-linux-gnu/devel)
  ...
  set(eigen_conversions_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include;/usr/include/eigen3;/opt/ros/indigo/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
