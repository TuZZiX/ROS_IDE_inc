...
if("FALSE" STREQUAL "TRUE")
  set(driver_base_SOURCE_PREFIX /tmp/buildd/ros-indigo-driver-base-1.6.8-2trusty-20150808-1035)
  set(driver_base_DEVEL_PREFIX /tmp/buildd/ros-indigo-driver-base-1.6.8-2trusty-20150808-1035/obj-x86_64-linux-gnu/devel)
  ...
  set(driver_base_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'driver_base' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Chad Rockey <chadrockey@gmail.com>' to fix it.")
    endif()
