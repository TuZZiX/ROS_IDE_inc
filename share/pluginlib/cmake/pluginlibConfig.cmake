...
if("FALSE" STREQUAL "TRUE")
  set(pluginlib_SOURCE_PREFIX /tmp/buildd/ros-indigo-pluginlib-1.10.1-0trusty-20150522-1820)
  set(pluginlib_DEVEL_PREFIX /tmp/buildd/ros-indigo-pluginlib-1.10.1-0trusty-20150522-1820/obj-x86_64-linux-gnu/devel)
  ...
  set(pluginlib_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pluginlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Esteve Fernandez <esteve@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(pluginlib_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/lib/x86_64-linux-gnu/libboost_filesystem.so;/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/lib/x86_64-linux-gnu/libtinyxml.so")
