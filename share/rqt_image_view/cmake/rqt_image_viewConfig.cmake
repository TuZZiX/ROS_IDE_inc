...
if("FALSE" STREQUAL "TRUE")
  set(rqt_image_view_SOURCE_PREFIX /tmp/buildd/ros-indigo-rqt-image-view-0.3.12-0trusty-20150807-1502)
  set(rqt_image_view_DEVEL_PREFIX /tmp/buildd/ros-indigo-rqt-image-view-0.3.12-0trusty-20150807-1502/obj-x86_64-linux-gnu/devel)
  ...
  set(rqt_image_view_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rqt_image_view' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Aaron Blasdel <ablasdel@gmail.com>' to fix it.")
    endif()
