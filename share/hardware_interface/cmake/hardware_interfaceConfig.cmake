...
if("FALSE" STREQUAL "TRUE")
  set(hardware_interface_SOURCE_PREFIX /tmp/buildd/ros-indigo-hardware-interface-0.9.3-0trusty-20150522-1840)
  set(hardware_interface_DEVEL_PREFIX /tmp/buildd/ros-indigo-hardware-interface-0.9.3-0trusty-20150522-1840/obj-x86_64-linux-gnu/devel)
  ...
  set(hardware_interface_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hardware_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
    endif()
