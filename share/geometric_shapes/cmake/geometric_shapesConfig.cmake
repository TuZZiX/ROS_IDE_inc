...
if("FALSE" STREQUAL "TRUE")
  set(geometric_shapes_SOURCE_PREFIX /tmp/buildd/ros-indigo-geometric-shapes-0.4.3-0trusty-20150522-1851)
  set(geometric_shapes_DEVEL_PREFIX /tmp/buildd/ros-indigo-geometric-shapes-0.4.3-0trusty-20150522-1851/obj-x86_64-linux-gnu/devel)
  ...
  set(geometric_shapes_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include;/opt/ros/indigo/include;/usr/include/eigen3;/usr/include " STREQUAL " ")
  set(geometric_shapes_INCLUDE_DIRS "")
  set(_include_dirs "include;/opt/ros/indigo/include;/usr/include/eigen3;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'geometric_shapes' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Ioan Sucan <isucan@google.com>, Dave Coleman <dave@dav.ee>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'geometric_shapes' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@google.com>, Dave Coleman <dave@dav.ee>' to fix it.")
    endif()
    _list_append_unique(geometric_shapes_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "geometric_shapes;/opt/ros/indigo/lib/liboctomap.so;/opt/ros/indigo/lib/liboctomath.so;/usr/lib/x86_64-linux-gnu/libconsole_bridge.so")
...
set(depends "shape_msgs;random_numbers;eigen_stl_containers;visualization_msgs")
