...
if("FALSE" STREQUAL "TRUE")
  set(rqt_robot_dashboard_SOURCE_PREFIX /tmp/buildd/ros-indigo-rqt-robot-dashboard-0.4.2-0trusty-20150808-0352)
  set(rqt_robot_dashboard_DEVEL_PREFIX /tmp/buildd/ros-indigo-rqt-robot-dashboard-0.4.2-0trusty-20150808-0352/obj-x86_64-linux-gnu/devel)
  ...
  set(rqt_robot_dashboard_INSTALL_PREFIX /opt/ros/indigo)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rqt_robot_dashboard' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Aaron Blasdel <ablasdel@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rqt_robot_dashboard' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Aaron Blasdel <ablasdel@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rqt_robot_dashboard_dep}_FOUND)
      find_package(${rqt_robot_dashboard_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rqt_robot_dashboard_dep} REQUIRED ${depend_list})
  endif()
