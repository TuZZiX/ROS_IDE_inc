...
if("FALSE" STREQUAL "TRUE")
  set(pointcloud_to_laserscan_SOURCE_PREFIX /tmp/buildd/ros-indigo-pointcloud-to-laserscan-1.3.0-0trusty-20150806-2006)
  set(pointcloud_to_laserscan_DEVEL_PREFIX /tmp/buildd/ros-indigo-pointcloud-to-laserscan-1.3.0-0trusty-20150806-2006/obj-x86_64-linux-gnu/devel)
  ...
  set(pointcloud_to_laserscan_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pointcloud_to_laserscan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Paul Bovbel <paul@bovbel.com>' to fix it.")
    endif()
