...
if("FALSE" STREQUAL "TRUE")
  set(laser_filters_SOURCE_PREFIX /tmp/buildd/ros-indigo-laser-filters-1.7.3-0trusty-20150807-0732)
  set(laser_filters_DEVEL_PREFIX /tmp/buildd/ros-indigo-laser-filters-1.7.3-0trusty-20150807-0732/obj-x86_64-linux-gnu/devel)
  ...
  set(laser_filters_INSTALL_PREFIX /opt/ros/indigo)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'laser_filters' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Jon Binney <jbinney@willowgarage.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'laser_filters' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Jon Binney <jbinney@willowgarage.com>' to fix it.")
    endif()
...
set(depends "cmake_modules;sensor_msgs;roscpp;tf;filters;message_filters;laser_geometry;pluginlib;angles")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${laser_filters_dep}_FOUND)
      find_package(${laser_filters_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${laser_filters_dep} REQUIRED ${depend_list})
  endif()
