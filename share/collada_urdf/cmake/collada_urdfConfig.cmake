...
if("FALSE" STREQUAL "TRUE")
  set(collada_urdf_SOURCE_PREFIX /tmp/buildd/ros-indigo-collada-urdf-1.11.8-0trusty-20150911-1748)
  set(collada_urdf_DEVEL_PREFIX /tmp/buildd/ros-indigo-collada-urdf-1.11.8-0trusty-20150911-1748/obj-x86_64-linux-gnu/devel)
  ...
  set(collada_urdf_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'collada_urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@gmail.com>' to fix it.")
    endif()
