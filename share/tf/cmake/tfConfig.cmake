...
if("FALSE" STREQUAL "TRUE")
  set(tf_SOURCE_PREFIX /tmp/buildd/ros-indigo-tf-1.11.7-0trusty-20150806-2228)
  set(tf_DEVEL_PREFIX /tmp/buildd/ros-indigo-tf-1.11.7-0trusty-20150806-2228/obj-x86_64-linux-gnu/devel)
  set(tf_INSTALL_PREFIX "")
  set(tf_PREFIX ${tf_DEVEL_PREFIX})
else()
  set(tf_SOURCE_PREFIX "")
  set(tf_DEVEL_PREFIX "")
  set(tf_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
