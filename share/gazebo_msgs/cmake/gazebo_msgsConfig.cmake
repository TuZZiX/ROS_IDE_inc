...
if("FALSE" STREQUAL "TRUE")
  set(gazebo_msgs_SOURCE_PREFIX /tmp/buildd/ros-indigo-gazebo-msgs-2.4.9-0trusty-20150816-0206)
  set(gazebo_msgs_DEVEL_PREFIX /tmp/buildd/ros-indigo-gazebo-msgs-2.4.9-0trusty-20150816-0206/obj-x86_64-linux-gnu/devel)
  ...
  set(gazebo_msgs_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'John Hsu <hsu@osrfoundation.org>' to fix it.")
    endif()
...
set(depends "message_runtime;std_msgs;trajectory_msgs;geometry_msgs;sensor_msgs;std_srvs;message_generation")
