...
if("FALSE" STREQUAL "TRUE")
  set(controller_manager_msgs_SOURCE_PREFIX /tmp/buildd/ros-indigo-controller-manager-msgs-0.9.3-0trusty-20150522-1215)
  set(controller_manager_msgs_DEVEL_PREFIX /tmp/buildd/ros-indigo-controller-manager-msgs-0.9.3-0trusty-20150522-1215/obj-x86_64-linux-gnu/devel)
  ...
  set(controller_manager_msgs_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
    endif()
