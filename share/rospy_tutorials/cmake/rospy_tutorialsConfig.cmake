...
if("FALSE" STREQUAL "TRUE")
  set(rospy_tutorials_SOURCE_PREFIX /tmp/buildd/ros-indigo-rospy-tutorials-0.5.3-0trusty-20150522-2054)
  set(rospy_tutorials_DEVEL_PREFIX /tmp/buildd/ros-indigo-rospy-tutorials-0.5.3-0trusty-20150522-2054/obj-x86_64-linux-gnu/devel)
  ...
  set(rospy_tutorials_INSTALL_PREFIX /opt/ros/indigo)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rospy_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rospy_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
set(rospy_tutorials_EXPORTED_TARGETS "rospy_tutorials_generate_messages_cpp;rospy_tutorials_generate_messages_lisp;rospy_tutorials_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rospy_tutorials_dep}_FOUND)
      find_package(${rospy_tutorials_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rospy_tutorials_dep} REQUIRED ${depend_list})
  endif()
