...
if("FALSE" STREQUAL "TRUE")
  set(gazebo_ros_control_SOURCE_PREFIX /tmp/buildd/ros-indigo-gazebo-ros-control-2.4.9-0trusty-20150911-2139)
  set(gazebo_ros_control_DEVEL_PREFIX /tmp/buildd/ros-indigo-gazebo-ros-control-2.4.9-0trusty-20150911-2139/obj-x86_64-linux-gnu/devel)
  ...
  set(gazebo_ros_control_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_ros_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Jonathan Bohren <jbo@jhu.edu>, Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
    endif()
